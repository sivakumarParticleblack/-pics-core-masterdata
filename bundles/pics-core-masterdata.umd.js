(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MasterdataComponent = /** @class */ (function () {
        function MasterdataComponent(permissionStore, _storeservice, fb) {
            this.permissionStore = permissionStore;
            this._storeservice = _storeservice;
            this.fb = fb;
            this.RBACORG = new RBACINFO();
        ...
        MasterdataComponent.prototype.ngOnInit = function () {
            ...
            this.mastersEvent.subscribe(function (val) {
                ...
                _this.categoryForm.get('name').valueChanges.subscribe(function (value) {
                    _this.checkTextOverflow(value);
                });
            });
        };
        MasterdataComponent.prototype.ngAfterViewInit = function () {
            this.checkTextOverflow(this.categoryForm.get('name').value);
        };
        MasterdataComponent.prototype.onInput = function (event, fieldName, fieldLabel, isRequired) {
            this.checkTextOverflow(event.target.value);
        };
        MasterdataComponent.prototype.checkTextOverflow = function (value) {
            var _this = this;
            setTimeout(function () {
                var inputElement = _this.nameInput.nativeElement;
                if (inputElement) {
                    _this.isTextOverflow = inputElement.scrollWidth > inputElement.clientWidth;
                }
            });
        };
        return MasterdataComponent;
    }());
    MasterdataComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: MasterdataComponent, deps: [{ token: PermissionStore }, { token: DataStoreService }, { token: i2__namespace$1.FormBuilder }], target: i0__namespace.ɵɵFactoryTarget.Component });
    MasterdataComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: MasterdataComponent, selector: "masterdata", inputs: { RBACORG: "RBACORG", PERMISSION: "PERMISSION", mastersEvent: "mastersEvent", INPUTVALIDATIONMETHOD: "INPUTVALIDATIONMETHOD" }, viewQueries: [{ propertyName: "nameInput", first: true, predicate: ["nameInput"], descendants: true }], ngImport: i0__namespace, template: "\n      <lib-masterdata></lib-masterdata>\n  ", isInline: true, components: [{ type: MasterdataComponent$1, selector: "lib-masterdata" }] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: MasterdataComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: PermissionStore }, { type: DataStoreService }, { type: i2__namespace$1.FormBuilder }]; }, propDecorators: { RBACORG: [{
                    type: i0.Input
                }], PERMISSION: [{
                    type: i0.Input
                }], mastersEvent: [{
